...
2)  Export the spreadsheet as sample_racetrack.csv  
...
dataFile = 'final_project_track.csv'
...
outFile = open("finalproject.world",'w')
...
print "See 'course_ubusername.world'.  RENAME THIS FILE WITH YOUR UB USERNAME."
